...
favorite_gene = "BRCA2" #Repairs damaged DNA
organism = "Homo sapiens"

output_message = f"Hi, my name is {name}, a researcher at the {affiliation}. My favorite gene is {favorite_gene} in {organism}."
